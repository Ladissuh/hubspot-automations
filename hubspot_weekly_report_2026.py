...
"""
Týdenní export HubSpot dealů do Excelu (pevný cutoff):
- Filtr: closedate < 2027-01-01.
...
def main():
    ...
    week_label, _, _ = previous_week_label(now_local)
    cutoff_ms = iso_to_epoch_ms(CUTOFF_DATE_ISO)
